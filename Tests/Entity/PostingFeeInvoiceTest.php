...
namespace HarvestCloud\InvoiceBundle\Tests\Entity;

use HarvestCloud\InvoiceBundle\Entity\Invoice;
use HarvestCloud\InvoiceBundle\Entity\PostingFeeInvoice;
...
class PostingFeeInvoiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor($order, $exchange)
    {
        ...
        $this->assertEquals(get_class($invoice), 'HarvestCloud\InvoiceBundle\Entity\PostingFeeInvoice');
    }
